document.addEventListener("DOMContentLoaded", () => {
  ...
  document
    ...
    ?.addEventListener("click", () => goTo("account"));
  document
    .getElementById("btnRevops")
    ?.addEventListener("click", () => goTo("revops"));
  document
    .getElementById("btnFunnel")
    ?.addEventListener("click", () => goTo("funnel"));
});
